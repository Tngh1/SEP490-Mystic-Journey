...
if(hud==null){ foreach(var g in UnityEngine.Object.FindObjectsByType<GameObject>(UnityEngine.FindObjectsInactive.Include,UnityEngine.FindObjectsSortMode.None)) if(g.name=="HUD"){hud=g;break;} }
var sb=new System.Text.StringBuilder();
if(hud==null) return "HUD not found";
